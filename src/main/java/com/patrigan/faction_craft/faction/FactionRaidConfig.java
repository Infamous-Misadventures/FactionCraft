...
public class FactionRaidConfig {
    ...
    public static final FactionRaidConfig GAIA = new FactionRaidConfig(false, "event.minecraft.raid", "event.minecraft.raid.victory", "event.minecraft.raid.defeat", 1, Optional.empty(), Optional.empty(), Optional.empty());
    public static final FactionRaidConfig PLAYER = new FactionRaidConfig(false, "event.minecraft.raid", "event.minecraft.raid.victory", "event.minecraft.raid.defeat", 1, Optional.empty(), Optional.empty(), Optional.empty());
