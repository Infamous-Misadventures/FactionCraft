...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> RECONSTRUCT_BLOCK = registerBlock("reconstruct_block", () -> new ReconstructBlock(BlockBehaviour.Properties.of(Material.METAL, MaterialColor.NONE).noCollission().noOcclusion().noDrops()));
