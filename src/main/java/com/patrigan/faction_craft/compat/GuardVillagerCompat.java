...
import static com.patrigan.faction_craft.config.FactionCraftConfig.VILLAGE_RAID_IRON_GOLEM_WEIGHT;
...
public class GuardVillagerCompat {
    ...
    private static EntityType<?> getRegisteredEntityType(String item) {
        return ForgeRegistries.ENTITIES.getValue(getResource(item));
    }
